...
<!--            <div class="list-group">-->
<!--                <a href="user_list.php" class="list-group-item active" >用户管理</a>-->
<!--                <a href="user_search111.php" class="list-group-item">用户搜索</a>-->
<!--                <a href="user_list.php" class="list-group-item">添加用户</a>-->
<!--            </div>-->
<!--        </div>-->
<!--        <div class="col-md-10">-->
<!--            <div class="page-header">-->
